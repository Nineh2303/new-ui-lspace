...
<template>
  <div class="w-full lg:w-56 shrink-0 space-y-6">
    ...
    <div class="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm">
      <div class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-3 px-2">KỸ NĂNG</div>
      <div class="space-y-1">
        <button v-for="item in categoryFilters" :key="item.id"
                ...
                :class="currentCategory === item.id ? 'bg-[#4572ED] text-white shadow-md shadow-blue-500/20 font-bold' : 'text-slate-600 hover:bg-slate-50 font-medium'">
