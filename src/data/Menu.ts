import { Home, Headphones, BookOpen, Edit3, Mic, Type, BookA, PenTool, CheckCircle, BarChart, Clock, BookMarked, Settings, FileText, Video, Newspaper } from 'lucide-vue-next';
...
export const menuGroups: IMenuGroup[] = [
  {
    title: 'Tổng quan',
    items: [
      { name: 'Trang chủ', icon: Home, isActive: true, route: '/' }
    ]
  },
  {
    title: 'Khám phá',
    items: [
      { name: 'Video bài giảng', icon: Video, route: '/videos' },
      { name: 'Bài viết', icon: Newspaper, route: '/articles' },
